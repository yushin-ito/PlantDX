...
type UpdateNodeFormProps = {
  form: ReturnType<typeof useForm<z.infer<typeof UpdateNodeSchema>>>;
  onSubmit: (values: z.infer<typeof UpdateNodeSchema>) => void;
  onCancel: () => void;
  error: string;
  isMutating: boolean;
};

const UpdateNodeForm = memo(
  ({ form, onSubmit, onCancel, error, isMutating }: UpdateNodeFormProps) => (
    <Form {...form}>
