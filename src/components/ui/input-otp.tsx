...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex size-11 items-center justify-center rounded-md border border-neutral-200 text-xl shadow-sm transition-all dark:border-neutral-800",
        isActive && "z-10 ring-1 ring-brand-600",
        className
      )}
      {...props}
    >
