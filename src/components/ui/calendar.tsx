    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-7 bg-transparent p-0 opacity-100"
        ),
        ...
        head_cell:
          "text-neutral-500 rounded-md w-7 font-normal text-[0.8rem] dark:text-neutral-400",
        ...
        day_selected:
          "!bg-brand-600 !text-neutral-50 hover:bg-brand-600 hover:text-neutral-50 focus:bg-brand-600 focus:text-neutral-50",
        day_today:
