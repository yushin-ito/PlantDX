...
import { ThemeSwitch } from "@/src/components/molecules/ThemeSwitch";
import { GithubIcon, SearchIcon, NotionLogo } from "../atoms/Icons";
...
const NavbarTop = () => {
  ...
  return (
    <NextUINavbar position="sticky" className="bg-light text-white">
      <NavbarContent className="basis-1" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-1" href="/">
            <h1
              className="light:font-bold text-black
      ...
      <NavbarContent className="basis-1/2">
        <h1
          className="light:text-2xl font-bold
      ...
      <NavbarContent className="hidden lg:flex basis-1/5" justify="end">
        ...
        >
          <SelectItem key={1} value="JP">
            JP
          </SelectItem>
          <SelectItem key={2} value="EN">
            EN
          </SelectItem>
        </Select>
      </NavbarContent>
